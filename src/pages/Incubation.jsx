              ...
              <div key={b.id} className="card" style={{ borderTop: `3px solid #1565C0` }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 12 }}>
                  {[
                    ...
                    ['📅', b.dateLoaded || '—'],
                    ['🎯', b.expectedHatch || 'Not set'],
                  ].map(([icon, val]) => (
                    <div key={val} style={{ background: 'var(--bg)', borderRadius: 6, padding: '6px 10px', fontSize: 12, display: 'flex', alignItems: 'center', gap: 6 }}>
                      <span>{icon}</span>
                ...
                <div style={{ marginBottom: 14 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 5 }}>
                    <span style={{ fontSize: 11, color: 'var(--text2)' }}>Incubation Progress ({incubationDays} days)</span>
