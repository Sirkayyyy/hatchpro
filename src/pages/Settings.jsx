...
export default function Settings() {
  ...
  const exportData = () => {
    ...
    a.href = url
    a.download = `hatchpro-backup-${new Date().toISOString().slice(0, 10)}.json`
    a.click()
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, alignItems: 'start' }}>
        <div className="card">
          ...
          <div style={{ fontSize: 12, color: 'var(--text2)', marginBottom: 20 }}>
            These values affect egg capacity tracking and progress calculations.
          </div>
          ...
          <div className="input-group">
            <label className="input-label">
              ...
              <span style={{ marginLeft: 8, fontSize: 10, background: '#E3F2FD', color: '#1565C0', padding: '2px 7px', borderRadius: 10, fontWeight: 600 }}>
                {activeEggs.toLocaleString()} eggs currently active
              </span>
            </label>
            <input className="input" type="number" min={1} value={form.capacity} onChange={upd('capacity')} />
            <div style={{ fontSize: 11, color: 'var(--text3)', marginTop: 3 }}>Default: 900,000 eggs</div>
          </div>
          ...
          <div className="input-group">
            ...
            <div style={{ fontSize: 11, color: 'var(--text3)', marginTop: 3 }}>Default: 21 days</div>
          </div>
          ...
          <div className="input-group">
            ...
            <div style={{ fontSize: 11, color: 'var(--text3)', marginTop: 3 }}>Default: Day 7</div>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div className="card">
            ...
            <div style={{ background: 'var(--bg)', borderRadius: 8, padding: 12, marginBottom: 16 }}>
              {[
                ...
                ['Eggs in active batches', activeEggs.toLocaleString()],
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, padding: '8px 16px', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer', background: '#fff', border: '1px solid var(--border)', color: 'var(--text)' }}>
                📥 Import Backup (JSON)
          ...
          <div className="card">
            ...
            <div style={{ fontSize: 12, color: 'var(--text2)', lineHeight: 1.8 }}>
              ...
              <div><strong>Max Egg Capacity:</strong> {form.capacity.toLocaleString()} eggs</div>
              <div><strong>Incubation Duration:</strong> {form.incubationDays} days</div>
