...
function CandlingModal({ batch, onClose }) {
  ...
  return (
    <Modal
      ...
      footer={
        <>
          ...
          <button className="btn btn-primary" style={{ background: 'var(--amber)', color: '#1F2937' }} onClick={save}>
            🐣 Move to Hatching
          </button>
        </>
      }
    >
      ...
      <Field label="Fertile Eggs" required hint="Number of eggs confirmed viable">
        <input
          className="input"
          type="number"
          min={0}
