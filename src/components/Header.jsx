      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        <div className="capacity-badge">
          ...
          <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--green)' }}>
            {occupied.toLocaleString()}/{capacity.toLocaleString()} eggs
          </span>
          <span style={{ fontSize: 12, color: '#81C784' }}>· {available.toLocaleString()} free</span>
        </div>
        ...
        <button
          ...
          style={{
            ...
            padding: 6, borderRadius: 6, color: 'var(--text2)',
