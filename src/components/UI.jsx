...
export function Alert({ type = 'info', children }) {
  const configs = {
    danger:  { Icon: MdError,       cls: 'alert-danger'  },
    success: { Icon: MdCheckCircle, cls: 'alert-success' },
    warning: { Icon: MdWarning,     cls: 'alert-warning' },
    info:    { Icon: MdInfo,        cls: 'alert-info'    },
  }
...
export function StatCard({ label, value, icon, color = 'var(--green)', sub }) {
  return (
    <div className="stat-card">
      ...
      <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.5px', textTransform: 'uppercase', color: 'var(--text2)', marginBottom: 4 }}>
        {label}
      </div>
      <div style={{ fontSize: 28, fontWeight: 700, fontFamily: 'Space Grotesk', color, lineHeight: 1 }}>
        {value}
      </div>
