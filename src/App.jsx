  ...
  return (
    <div className="app">
      ...
      <div className={`main ${!sidebarOpen ? 'main-full' : ''}`}>
        <Header title={PAGE_TITLES[pathname] || 'HatchPro'} onToggleSidebar={() => setSidebarOpen(o => !o)} />
      ...
      <ToastContainer position="top-right" autoClose={3000} newestOnTop theme="light" toastStyle={{ fontFamily: 'DM Sans, sans-serif', fontSize: 13 }} />
    </div>
  )
}
